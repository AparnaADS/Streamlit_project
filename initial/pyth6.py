...
def main():
    ...
    df = load_data()
    # Sidebar filters
    vendors = df["vendor_name"].unique().tolist()
    sel_vendor = st.sidebar.multiselect("Vendor", options=vendors, default=None)
    statuses = df["status"].unique().tolist()
    sel_status = st.sidebar.multiselect("Status", options=statuses, default=None)
    if sel_vendor:
